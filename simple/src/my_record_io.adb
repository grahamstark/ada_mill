--
-- Created by ada_generator.py on 2013-04-04 19:42:22.600096
-- 
with Simple_Pg_Data;
...
package body My_Record_IO is
   ...
   log_trace : GNATColl.Traces.Trace_Handle := GNATColl.Traces.Create( "MY_RECORD_IO" );
